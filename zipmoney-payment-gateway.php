...
function run_zipmoney_payment_gateway()
{
    ...
    {
        if( isset( $value->response['woocommerce-zipmoneypayment-v1.0.0/zipmoney-payment-gateway.php'] ) )
            unset( $value->response['woocommerce-zipmoneypayment-v1.0.0/zipmoney-payment-gateway.php'] );
        return $value;
    });
}
