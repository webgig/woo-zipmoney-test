...
function run_zipmoney_payment_gateway()
{
    ...
    {
        if( isset( $value->response['woocommerce-zipmoneypayment-v2.0.0/zipmoney-payment-gateway.php'] ) )
            unset( $value->response['woocommerce-zipmoneypayment-v2.0.0/zipmoney-payment-gateway.php'] );
        return $value;
    });
}
